var NioApp = function (i, w) {
    ...
    return w.fn.exists = function () {
        ...
        let a = s.querySelectorAll(`.${t.selectors.nav} > *`),
            ...
            n = (s.querySelector("." + t.selectors.progress), s.querySelector(`.${t.selectors.progress}-count`)),
    ...
    function i(t) {
        t = "object" == typeof t ? e : t, o.winLoad.concat(o.winLoadDefer).forEach(function (e) {
            null != e && e(t)
        })
    }

    function r(t) {
        t = "object" == typeof t ? e : t, o.onResize.concat(o.onResizeDefer).forEach(function (e) {
            null != e && e(t)
        })
    }
