...
function toasterNaranja(title, message, timeOut = 3000) {
    this.title = title;
    this.message = message;
    this.timeOut = timeOut;
}

toasterNaranja.prototype.log = function () {
    naranja()['log']({ title: this.title ? this.title : "Information", text: this.message, timeout: this.timeOut });
}

toasterNaranja.prototype.error = function () {
    naranja()['error']({ title: this.title ? this.title : "Error", text: this.message, timeout: this.timeOut });
}

toasterNaranja.prototype.warn = function () {
    naranja()['warn']({ title: this.title ? this.title : "Warning!", text: this.message, timeout: this.timeOut });
}

toasterNaranja.prototype.success = function () {
    naranja()['success']({ title: this.title ? this.title : "Success!", text: this.message, timeout: this.timeOut });
}
